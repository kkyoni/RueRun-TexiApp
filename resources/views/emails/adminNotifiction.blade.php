            ...
            <div class="card" style="border-radius: 11px; width: 460px; box-shadow: 0px 5px 10px rgba(0, 0, 0, 0.5); border-top-color: #2c4292 !important">
                <div class="card-header pb-0 bg-white" style="border: 0; border-top: 14px solid #2c4292 !important; border-radius: 11px !important">
                    <div class="row justify-content-center mt-4">
                        <div class="col-9">
                            <img src="{{asset(\Settings::get('application_logo'))}}" class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="card-body" style="border-radius: 9px !important">
                    <p class="text-muted" style="text-align: left; padding-left: 15px; font-size: 17px; font-family: sans-serif;"> {{$title}}</p><mark style="background-color: #2c4292 !important"><small class="font-weight-bold" style="letter-spacing: 2px; text-align: left; padding-left: 15px; font-size: 17px; font-family: sans-serif; color: #FFF; background-color: #2c4292 !important">{!! strip_tags(htmlspecialchars_decode($text)) !!}</small></mark> <img src="{{asset('images/otp.jpg') }}" class="img-fluid" style="width: 350px !important" />
                    <div class="row justify-content-center mt-4">
...
=======
>>>>>>> ed10e633b617c71552b4d6a8aef9632ed14ab304
