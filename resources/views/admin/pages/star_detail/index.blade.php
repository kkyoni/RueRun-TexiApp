				...
				<div class="ibox-content">
					...
					<div class="col-md-12">
						<div class="table-responsive">
							...
							<option value="{{ route('admin.user_star.index') }}">User Start Rating</option>
							<option selected="selected" value="{{ route('admin.driver_star.index') }}">Driver Start Rating</option>
							</select>
	...
	<div class="modal_css">
		<div class="modal-content animated flipInY">
			<div class="modal-header">
				...
				<h4 class="modal-title">Driver Referral Details</h4>
			</div>
...
<script type="text/javascript">
	...
	$(document).on("click","a.driver_show",function(e){

		var id = $(this).attr('data-id');
		$.ajax({
			url:"{{route('admin.get_driver_info_data',[''])}}"+"/"+id,
			type: 'post',
			data: {"_token": "{{ csrf_token() }}"
		},
		success:function(data) {
