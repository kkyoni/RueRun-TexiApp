...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10"><h2>Emergency Contact Management</h2></div>
</div>
			...
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						@php 
						$checkPermission = \App\Helpers\Helper::checkPermission(['emergencycontact-create']);
						@endphp
						@if($checkPermission)
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn" href="{{route('admin.emergencycreate')}}">
...
<script type="text/javascript">
	$(document).on("click","a.deleteemergency",function(e){
		var row = $(this);
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{route('admin.emergencydelete',[''])}}"+"/"+id,
					type: 'post',
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					...
					type: 'post',
					data: {"_method": 'post','id':id,"_token": "{{ csrf_token() }}"
					},
					success:function(msg){
