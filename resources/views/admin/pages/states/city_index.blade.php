			...
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						@php 
						$checkPermission = \App\Helpers\Helper::checkPermission(['city-create']);
						@endphp
						@if($checkPermission)
...
<script type="text/javascript">
	$(document).on("click","a.deletecity",function(e){
		var row = $(this);
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{route('admin.states.city_delete',[''])}}"+"/"+id,
					type: 'post',
					data    : {
						_token: "{{ csrf_token() }}"
					},
	...
	$('#city').on('keyup onmouseout keydown keypress blur change', function (event) {
