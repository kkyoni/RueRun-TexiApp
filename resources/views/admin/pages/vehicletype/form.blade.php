...
<div class="form-group  row {{ $errors->has('name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Select Make </strong> <span class="text-danger">*</span></label>
	<div class="col-sm-6">{{ Form::select('model_id',$car_model,null,['placeholder' => 'Select','class'=>'form-control','required'])}}
		<span class="help-block">
			<font color="red"> {{ $errors->has('model_id') ? "".$errors->first('model_id')."" : '' }} </font>
		</span>
	</div>
</div>

<div class="form-group  row {{ $errors->has('name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Model Name</strong> <span class="text-danger">*</span></label>
