...
<div class="form-group row {{ $errors->has('contact_number') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Contact Number</strong> <span class="text-danger">*</span></label>
	<div class="col-sm-6">
		@if(\Request::route()->getName() == 'admin.driver.edit')
...
<div class="form-group row {{ $errors->has('vehicle_id') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Select Ranking</strong> <span class="text-danger"></span></label>
	<div class="col-sm-6">
...
<div class="form-group row {{ $errors->has('make') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Make</strong> <span class="text-danger"></span></label>
	<div class="col-sm-6">
		{!! Form::text('make',null,[
		'class' => 'form-control',
		'id'	=> 'make',
		...
		<span class="help-block">
			<font color="red"> {{ $errors->has('make') ? "".$errors->first('make')."" : '' }} </font>
		</span>
	</div>
</div>
...
<div class="form-group row {{ $errors->has('vehicle_image') ? 'has-error' : '' }}">
	...
	<div class="col-sm-6">
		<img src="{{ url('storage/vehicle_images/'.@$users->driver_details->vehicle_image) }}" onError="this.onerror=null;this.src='{!! url('storage/vehicle_images/default.png') !!}' " style="max-height: 200px;max-width: 200px;">
	</div>
</div>
@else
...
<div class ="remove_test">
	<strong><h3><b>Card Details :- {{$i}} </b></h3></strong>
	<div class="form-group  row {{ $errors->has('card_number') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Card Number</strong></label>
		<div class="col-sm-6">{!! Form::text('card_number[]',@$card_user->card_number,[
			'class' => 'form-control credit-card',
			'id'	=> 'credit-card',
			'maxlength'    =>  '19',
			'onkeypress' =>  'return isNumberKey(event)',$contactdisable
			]) !!}
	...
	<div class="form-group  row {{ $errors->has('card_holder_name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Card Holder Name</strong></label>
		<div class="col-sm-6">{!! Form::text('card_holder_name[]',$card_user->card_holder_name,[
			'class' => 'form-control',
	...
	<div class="form-group  row {{ $errors->has('card_name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Name of Card</strong></label>
		<div class="col-sm-6">{!! Form::text('card_name[]',$card_user->card_name,[
	...
	<div class="form-group  row {{ $errors->has('card_expiry_month') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Card Expiry Month</strong></label>
		<div class="col-sm-3">{!! Form::number('card_expiry_month[]',$card_user->card_expiry_month,[
			'class' => 'form-control w-45 date_abc date',$contactdisable,
			'id'            => 'date',
	...
	<div class="form-group  row {{ $errors->has('card_expiry_year') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Card Expiry Year</strong></label>
		<div class="col-sm-3">{!! Form::number('card_expiry_year[]',$card_user->card_expiry_year,[
			'class' => 'form-control year',
			'id'            => 'year',
			'data-provide'  => 'datepicker',$contactdisable
			]) !!}
			<span class="help-block">
	...
	<div class="form-group  row {{ $errors->has('cvv') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>CVV</strong></label>
		<div class="col-sm-6">{!! Form::text('cvv[]','***',['class' => 'form-control','id'=> 'cvv','maxlength'=>'3','onkeypress' =>  'return isNumberKey(event)',$contactdisable]) !!}
			<span class="help-block">
	...
	<div class="form-group  row {{ $errors->has('billing_address') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Billing Address</strong></label>
		<div class="col-sm-6">{!! Form::text('billing_address[]',$card_user->billing_address,[
			'class' => 'form-control',
	...
	<div class="form-group  row {{ $errors->has('bank_name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Bank Name</strong></label>
		<div class="col-sm-6">{!! Form::text('bank_name[]',$card_user->bank_name,[
			'class' => 'form-control',
	...
	{{--	<div style="cursor:pointer;background-color:red;" class="remove_field_id btn btn-info">Remove</div>--}}
</div>
<?php $i ++; ?>
@endforeach
@else
...
<div class="form-group  row {{ $errors->has('card_name') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Name of Card</strong></label>
	<div class="col-sm-6">{!! Form::text('card_name[]',null,[
		'class' => 'form-control','id'	=> 'card_name'
		]) !!}
		<span class="help-block">
			<font color="red"> {{ $errors->has('card_name') ? "".$errors->first('card_name')."" : '' }} </font>
		</span>
...
<div class="form-group  row {{ $errors->has('cvv') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>CVV</strong></label>
	<div class="col-sm-6">{!! Form::text('cvv[]',null,[
		'class' => 'form-control','id'	=> 'cvv','maxlength'=>'3','onkeypress' =>  'return isNumberKey(event)'
		]) !!}
		<span class="help-block">
			<font color="red"> {{ $errors->has('cvv') ? "".$errors->first('cvv')."" : '' }} </font>
		</span>
