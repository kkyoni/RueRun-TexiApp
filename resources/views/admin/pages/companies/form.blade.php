...
<div class="form-group row {{ $errors->has('contact_number') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Contact Number</strong> <span class="text-danger">*</span></label>
  ...
  <div class="col-sm-6">
    ...
    'maxlength' => '10',"data-number"=>"$company_detail->country_code$company_detail->contact_number"]) !!}
    @else
    {!! Form::tel('contact_number',null,['maxlength' => '10','class'=>'tel_no form-control']) !!}
    @endif
    <input type="hidden" name="country_code" id="countryCode" value="<?php if(isset($company_detail) && !empty($company_detail)) {
      echo $company_detail->country_code;
    } ?>">
    <input type="hidden" name="country_code_al" id="countryCodeal" value="">
    <input type="hidden" id="currentcode" value="<?php if(isset($company_detail) && !empty($company_detail)) {
      echo $company_detail->country_code_al;
    } ?>">
    @if(!empty($company_detail))
    <input type="hidden" name="contact_number" value="{{$company_detail->contact_number}}">
    @endif
    <span class="help-block">
...
<div class="form-group row {{ $errors->has('vehicle_image') ? 'has-error' : '' }}">
  ...
  <div class="col-sm-6">
    <input type="file" class="form-control vchange" name="vehicle_image">
    <span class="help-block">
