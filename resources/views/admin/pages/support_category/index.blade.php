...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Support Category Management</h2>
	</div>
	<div class="col-lg-2">
	</div>
</div>
			...
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						...
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn" href="{{route('admin.support_cat.create')}}">
...
<script type="text/javascript">
	$(document).on("click","a.deleteuser",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{route('admin.support_cat.delete',[''])}}"+"/"+id,
					type: 'post',
