...
<div class="wrapper wrapper-content">
                    ...
                    <div class="container">
                        ...
                        <div class="row wrapper border-bottom white-bg page-heading" style="background-color:#ffffff;    padding: 0px 0px 20px 0px;">
                            <div class="col-lg-12">
                                <form action="">
                                    Admin Type
                                    {{ Form::select('bank_office_level',$bank_office_level, $bol->id, array('id' => 'some-id','class' => 'form-control','onchange' => 'changeBankOfficeLevel(this)')) }}
                                </form>
                            </div>
                        </div>
                        <!-- <br/> -->
                        <!-- <h2 id="Operator_role" class="text-center">{{ $bol->first_name }} Permission</h2> -->
                        <!-- <br/> -->
                        {!! Form::open(array(
                        'route' => ['admin.role.add.update'],
                        'id'    => 'roleAddForm')) !!}
    ...
    <script>
        function changeBankOfficeLevel(e) {
            ...
            var text = '/admin/role/'+selectedBankOfficeLevel+'/edit';
            var url = "{{ url('/') }}"+text;
