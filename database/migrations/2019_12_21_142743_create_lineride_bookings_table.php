...
class CreateLinerideBookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lineride_bookings', function (Blueprint $table) {
            ...
            $table->string('seat_available',191)->nullable();
            $table->string('seat_booked',191)->nullable();
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('lineride_bookings');
    }
}
